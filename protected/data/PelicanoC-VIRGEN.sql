...
INSERT INTO `external_wsdl` VALUES (1,'Monitor','monitor','Monit0r357','http://domasolutions.com/pelicanoM/index.php?r=wsMonitor/wsdl');
...
/*!50001 CREATE TABLE `marketplace` (
  ...
  `already_downloaded` tinyint NOT NULL
) ENGINE=MyISAM */;
...
INSERT INTO `setting` VALUES (1,'./nzb',NULL,NULL,'http://localhost:8080/sabnzbd/api?','http://domasolutions.com','./nzbReady','./subtitles','./images','/media/NAS/','/pelicanos',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/home/pelicano/passwords',NULL,'/pelicano','/copied','/ripped',"/media/NAS/",0,"","","","","","1.0",80);
...
UPDATE `pelicanoc`.`setting` set version="2.49" where Id=1;
