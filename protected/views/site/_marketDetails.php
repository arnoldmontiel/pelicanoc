 <div class="modal-dialog">
   ...
   <?php echo $model->description;?>
    ...
    <button id="btn-play" type="button" class="btn btn-primary btn-large"><i class="fa fa-download"></i> Descargar</button>
    </div><!--/.modal-footer -->
  </div><!--/.modal-content -->
    </div><!--/.modal-dialog -->
  <script>
	$('#btn-download').click(function(){
		...
		$.post("<?php echo SiteController::createUrl('AjaxStartDownload'); ?>",
			...
			function(data) 
			{					
				window.location = <?php echo '"'. SiteController::createUrl('marketplace') . '"'; ?>;
				return false;
			}
		);
		return false;
