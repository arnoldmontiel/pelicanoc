...
class Nzb extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, Id_my_movie_disc_nzb, Id_resource, Id_nzb_state, url, path, file_name, subt_file_name, subt_url, downloading, downloaded, date, requested, points, ready, change_state_date, sent, Id_nzb_type, Id_nzb, mkv_file_name, ready_to_play, sabnzbd_size, sabnzbd_id, is_personal, has_error', 'safe', 'on'=>'search'),
		);
	}
