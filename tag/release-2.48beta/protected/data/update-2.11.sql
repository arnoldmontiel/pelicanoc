...
-- database script version 2.02
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.02" where Id=1;

COMMIT;

-- database script version 2.03
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.03" where Id=1;

COMMIT;

-- database script version 2.04
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.04" where Id=1;

COMMIT;

-- database script version 2.05
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.05" where Id=1;

COMMIT;

-- database script version 2.06
-------------------------------
...
-- database script version 2.08
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.08" where Id=1;

COMMIT;

-- database script version 2.09
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.09" where Id=1;

COMMIT;

-- database script version 2.10
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.10" where Id=1;

COMMIT;

-- database script version 2.11
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

UPDATE `pelicanoc`.`setting` set version="2.11" where Id=1;
