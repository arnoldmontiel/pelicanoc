...
.btnDescargar{position:relative; padding-right:100px;}
.labelPointsGroup{position:absolute; top:-1px; right:-1px;}
.labelPoints{background-color: rgba(255,255,255,0.3);
color: white;
display: inline-block;
height: 45px;
margin: 0px;
...
/* ------ END MODAL PELIS DETAIL ------- */

/* ------ MODAL POPUPS SERIES DETAIL ------- */

.modalDetail .table.tableCapitulos tbody>tr.notDownloaded td{color:#ccc;}

.modalDetail .table.tableCapitulos tbody>tr>td{padding: 5px 6px;
line-height: 31px;}
...
.flexslider .slides img.peliAfiche{width:180px; height:260px;}

#flexsliderMarket{height:320px;}
...
.flexslider .slides img.peliAfiche{width: 180px !important;height: 260px !important;}

.flexslider{ width:85%;}
.velocidadDescarga{padding-right:30px;}
...
.controlContainer .controlAfiche{padding-bottom:20px;}
.controlContainer .controlNumeros{ padding:10px 0px;}

.controlLenght{padding-top:0px; line-height:57px;}

.col-xs-1, .col-sm-1, .col-md-1, .col-lg-1, .col-xs-2, .col-sm-2, .col-md-2, .col-lg-2, .col-xs-3, .col-sm-3, .col-md-3, .col-lg-3, .col-xs-4, .col-sm-4, .col-md-4, .col-lg-4, .col-xs-5, .col-sm-5, .col-md-5, .col-lg-5, .col-xs-6, .col-sm-6, .col-md-6, .col-lg-6, .col-xs-7, .col-sm-7, .col-md-7, .col-lg-7, .col-xs-8, .col-sm-8, .col-md-8, .col-lg-8, .col-xs-9, .col-sm-9, .col-md-9, .col-lg-9, .col-xs-10, .col-sm-10, .col-md-10, .col-lg-10, .col-xs-11, .col-sm-11, .col-md-11, .col-lg-11, .col-xs-12, .col-sm-12, .col-md-12, .col-lg-12{padding-right:10px; padding-left:10px;}

.flexslider .flex-next{right:-33px !important;}
.flexslider .flex-prev{left:-33px !important;}
.flexslider:hover .flex-next{right:-35px !important;}
.flexslider:hover .flex-prev{left:-35px !important;}
