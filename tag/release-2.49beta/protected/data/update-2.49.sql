...
-- database script version 2.48
-------------------------------
SET AUTOCOMMIT=0;
START TRANSACTION;

update pelicanoc.my_movie set Id_parental_control = 5 where Id_parental_control = 6;
update pelicanoc.my_movie_nzb set Id_parental_control = 5 where Id_parental_control = 6;
update pelicanoc.my_movie set Id_parental_control = 2 where Id_parental_control = 3;
update pelicanoc.my_movie_nzb set Id_parental_control = 2 where Id_parental_control = 3;

delete from pelicanoc.parental_control where Id IN (3,6);

COMMIT;

-- database script version 2.49
-------------------------------

SET AUTOCOMMIT=0;
START TRANSACTION;

update setting set host_name="http://domasolutions.com" where Id=1;
