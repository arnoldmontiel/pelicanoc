...
<div class="modal-content">
   ...
   <ul class="nav nav-tabs">
						...
						<li class="active"><a href="#tab1" data-toggle="tab">Temp. 1</a></li>
						<li class=""><a href="#tab1" data-toggle="tab">Temp. 2</a></li>
						<li class=""><a href="#tab1" data-toggle="tab">Temp. 3</a></li>
						<li class=""><a href="#tab1" data-toggle="tab">Temp. 4</a></li>
						<li class=""><a href="#tab1" data-toggle="tab">Temp. 5</a></li>
	</ul>
