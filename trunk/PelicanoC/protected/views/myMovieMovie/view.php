...
<div id="conteiner" class="movie-view" style="">
	...
	<div style="width: 205px; float:left;">
		<?php echo CHtml::image( "images/".$model->myMovieMovie->poster, $model->myMovieMovie->original_title,array('id'=>'MyMovieMovie_Poster_img', 'style'=>'height: 290px;width: 190px;margin: 5px 5px 5px 7px;')); ?>

	</div>
	<div style="float: left;padding: 5px 10px; width: 50%">
	<?php echo CHtml::openTag('div',array('class'=>'movie-title'));?>
			<?php echo $model->myMovieMovie->original_title . " (".$model->myMovieMovie->production_year.")"; ?>
		<?php echo CHtml::closeTag('div');?> 
	<br>
	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('genre').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->genre; ?>		
	<?php echo CHtml::closeTag('div');?> 
	
	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('country').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->country; ?>
	<?php echo CHtml::closeTag('div');?> 

	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('description').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->description; ?>
	<?php echo CHtml::closeTag('div');?> 
	
	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('running_time').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->running_time; ?>
	<?php echo CHtml::closeTag('div');?>
	 
	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('imdb').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->imdb; ?>
	<?php echo CHtml::closeTag('div');?>
	...
	<?php echo CHtml::openTag('div');?>
		<?php echo CHtml::openTag('b');?>
			<?php echo $model->myMovieMovie->getAttributeLabel('studio').':'; ?>
		<?php echo CHtml::closeTag('b');?>
		<?php echo $model->myMovieMovie->studio; ?>
	<?php echo CHtml::closeTag('div');?>
	...
	<?php echo CHtml::openTag('div',array('class'=>'movie-rating'));?>
		<?php echo $model->myMovieMovie->rating; ?>
	<?php echo CHtml::closeTag('div');?> 
	</div>
